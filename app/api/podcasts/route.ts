...
// Audio image generation handled by separate cron (scripts/gen-audio-images.ts)
// not inline — too slow for ISR cycle
...
export async function GET() {
  ...
  // TODO: Audio images generated by separate cron script and stored in KV
  // Too slow to generate inline (~30 shows × 8s each = 4 min)
